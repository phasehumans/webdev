            ...
            <div className="w-64 shrink-0 border-r border-white/5 hidden lg:flex flex-col h-full overflow-y-auto bg-[#050505]">
                ...
                <div className="px-6 pb-10 space-y-8">
                    {sidebarLinks.map((group, idx) => (
                        <div key={idx}>
                            <h4 className="text-xs font-bold text-neutral-500 uppercase tracking-widest mb-3 font-mono">{group.section}</h4>
                ...
                <div className="max-w-4xl mx-auto px-6 py-10 lg:px-12 lg:py-16">
                    ...
                    <div className="mb-12">
                        ...
                        <p className="text-xl text-neutral-400 font-light leading-relaxed max-w-2xl">
                            PhaseHumans is an interface synthesis engine that bridges the gap between natural language intent and high-fidelity production code.
                        </p>
                    </div>
                    ...
                    <div className="space-y-12">
                        ...
                        <section>
                            ...
                            <p className="text-neutral-400 leading-7 mb-6">
                                Traditional UI development involves a lot of boilerplate and repetitive setup. PhaseHumans treats UI as a function of intent. You describe the <em className="text-white not-italic">what</em>, and our engine handles the <em className="text-white not-italic">how</em>.
                            </p>
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="p-4 rounded-xl border border-white/10 bg-[#0A0A0A]">
                                    ...
                                    <h3 className="text-white font-medium mb-1">Semantic Parsing</h3>
                                    <p className="text-sm text-neutral-500">Understands context, framework preferences, and styling constraints automatically.</p>
                                </div>
                                <div className="p-4 rounded-xl border border-white/10 bg-[#0A0A0A]">
                                    <div className="w-8 h-8 rounded-lg bg-purple-500/10 flex items-center justify-center text-purple-400 mb-3">
                                        <Layers size={18} />
                                    </div>
                                    <h3 className="text-white font-medium mb-1">Component Hierarchy</h3>
                                    <p className="text-sm text-neutral-500">Generates atomic components that are reusable and follow best practices.</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <CodeBlock code={`phase init my-new-project\ncd my-new-project\nphase dev`} />
                        </section>
                                ...
                                <div className="aspect-[21/9] bg-[#050505] rounded-lg relative flex items-center justify-center border border-white/5">
                                    <div className="flex items-center gap-4 text-xs font-mono text-neutral-500">
                                        <div className="flex flex-col items-center gap-2">
                                            <div className="w-16 h-12 rounded border border-neutral-700 bg-neutral-900 flex items-center justify-center">Input</div>
                                            <span className="text-[10px]">Prompt</span>
                                        </div>
                                        <div className="w-8 h-px bg-neutral-700" />
                                        <div className="flex flex-col items-center gap-2">
                                            <div className="w-20 h-20 rounded border border-blue-500/30 bg-blue-500/5 flex items-center justify-center text-blue-400">Engine</div>
                                            <span className="text-[10px]">Processing</span>
                                        </div>
                                        <div className="w-8 h-px bg-neutral-700" />
                                        <div className="flex flex-col items-center gap-2">
                                            <div className="w-16 h-12 rounded border border-neutral-700 bg-neutral-900 flex items-center justify-center">Output</div>
