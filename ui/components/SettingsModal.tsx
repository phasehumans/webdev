...
import { GitHubIcon, VercelIcon, NotionIcon, SupabaseIcon } from './icons/BrandIcons';
                        ...
                        <div className="w-full max-w-lg bg-[#09090b] border border-white/10 rounded-2xl shadow-2xl pointer-events-auto flex flex-col overflow-hidden ring-1 ring-white/5 max-h-[85vh]">
                            ...
                            <div className="p-5 space-y-8 bg-[#09090b] overflow-y-auto custom-scrollbar">
                                ...
                                <div className="space-y-4">
                                    <h3 className="text-[11px] font-medium text-neutral-500 uppercase tracking-wider">Profile</h3>
                                    <div className="grid grid-cols-2 gap-3">
                                        <SettingsInput label="First Name" defaultValue="Alex" />
                                        <SettingsInput label="Last Name" defaultValue="Chen" />
                                    </div>
                                    <SettingsInput label="Email" defaultValue="alex@phasehumans.ai" />
                                </div>
                                ...
                                <div className="space-y-4">
                                     <div className="flex items-center justify-between">
                                        <div>
                                            <h3 className="text-[11px] font-medium text-neutral-500 uppercase tracking-wider mb-1">Notifications</h3>
                                            <p className="text-xs text-neutral-400">Receive weekly digests</p>
                                        </div>
                                        <button 
                                        ...
                                        >
                                            <div className={cn(
                                                ...
                                                isEmailEnabled ? "left-[calc(100%-1.125rem)]" : "left-0.5 bg-neutral-400"
                                            )} />
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <h3 className="text-[11px] font-medium text-neutral-500 uppercase tracking-wider">Integrations</h3>
