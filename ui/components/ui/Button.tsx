...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "md", isLoading, children, ...props }, ref) => {
    const variants = {
      primary: "bg-white text-black hover:bg-neutral-200 shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.2)] border border-transparent active:scale-95",
      secondary: "bg-neutral-800 text-white hover:bg-neutral-700 border border-white/5",
      ghost: "text-neutral-400 hover:text-white hover:bg-white/5 border border-transparent",
      danger: "text-red-400 hover:text-red-300 hover:bg-red-500/10 border border-transparent",
