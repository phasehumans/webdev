                ...
                <div className="relative z-10 space-y-6 max-w-md">
                    <div className="space-y-2">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-xs text-neutral-500 font-mono">Spice Harvester / Specs</span>
                        </div>
                        <h4 className="text-3xl font-bold text-white tracking-tight">
                            <span className="bg-white/5 px-2 rounded-lg decoration-clone leading-relaxed py-1">Collaborate on</span>
                            <br />
                    ...
                    <div className="space-y-4 text-sm text-neutral-400 font-light leading-relaxed font-sans border-l-2 border-white/5 pl-4">
                        ...
                        <p className="relative">
                            Add <span className="text-white font-medium bg-white/10 px-1 rounded">**style**</span> and <span className="text-blue-400 font-medium bg-blue-500/10 px-1 rounded">##structure</span> with rich-text formatting options directly in the canvas.
                        </p>
                    </div>
