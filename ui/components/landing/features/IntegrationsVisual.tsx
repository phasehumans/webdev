    ...
    <div className="absolute inset-0 bg-[#050505] flex items-center justify-center">
      <div className="relative z-10 grid grid-cols-4 gap-6 px-6 w-full max-w-[320px]">
        <IntegrationItem
          icon={GitHubIcon}
          name="GitHub"
          color="bg-white/5 text-white border-white/10 group-hover:bg-white/10"
          delay={0.05}
        />
        <IntegrationItem
          icon={VercelIcon}
          name="Vercel"
          color="bg-black text-white border-white/10 group-hover:border-white/20"
          delay={0.1}
        />
        <IntegrationItem
          icon={NotionIcon}
          name="Notion"
          color="bg-white/90 text-black border-white/5 group-hover:bg-white"
          delay={0.15}
        />
        <IntegrationItem
          icon={SupabaseIcon}
          name="Supabase"
          color="bg-[#3ECF8E]/10 text-[#3ECF8E] border-[#3ECF8E]/20 group-hover:bg-[#3ECF8E]/20"
          delay={0.2}
        />
      </div>
