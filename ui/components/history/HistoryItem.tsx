...
import { ArrowUpRight, Sparkles, Layout, MonitorPlay, Code2 } from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            <div className={cn(
                ...
                item.type === 'SaaS' ? "bg-blue-500/10 border-blue-500/10 text-blue-400" :
                item.type === 'Dashboard' ? "bg-emerald-500/10 border-emerald-500/10 text-emerald-400" :
                item.type === 'Portfolio' ? "bg-purple-500/10 border-purple-500/10 text-purple-400" :
                "bg-neutral-800 border-white/5 text-neutral-400"
            )}>
                {item.type === 'SaaS' ? <Sparkles size={18} /> : 
                    item.type === 'Dashboard' ? <Layout size={18} /> :
                    item.type === 'Landing' ? <MonitorPlay size={18} /> :
                    <Code2 size={18} />}
            </div>
