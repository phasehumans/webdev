...
export const ProjectsPage: React.FC<ProjectsPageProps> = ({ onNewProject, onOpenProject }) => {
    return (
            ...
            <div className="max-w-[1600px] mx-auto p-6 md:p-10 space-y-10">
                ...
                <div className="flex flex-row items-end justify-between border-b border-white/5 pb-6">
                    <div className="space-y-1">
                        <h1 className="text-3xl font-display font-medium tracking-tight text-white">Projects</h1>
