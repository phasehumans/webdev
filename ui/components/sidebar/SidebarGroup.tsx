...
export const SidebarGroup: React.FC<SidebarGroupProps> = ({ 
    ...
    if (isCollapsed) {
        return (
             <button 
                className="flex items-center justify-center w-full p-2 rounded-lg text-neutral-500 hover:text-white hover:bg-white/5 transition-colors group relative"
            >
    ...
    return (
        <div className="mb-1">
            ...
            >
                <Icon size={18} strokeWidth={1.5} className="shrink-0 mr-3 text-neutral-500 group-hover:text-neutral-300" />
