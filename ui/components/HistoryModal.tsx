...
const historyItems = [
    { id: 1, title: 'Phase Humans Final', description: 'A prompt-to-website generator with a high-fidelity dark mode UI.', time: '8m ago', type: 'SaaS', pinned: true },
    { id: 2, title: 'E-commerce Dashboard', description: 'Modern dark mode dashboard for shopify store analytics.', time: '53m ago', type: 'Dashboard', pinned: false },
    { id: 3, title: 'SaaS Landing Page', description: 'High conversion landing page for AI tool with pricing grids.', time: '1h ago', type: 'Landing', pinned: false },
    { id: 4, title: 'Portfolio v2', description: 'Minimalist portfolio for photographer focusing on imagery.', time: '2h ago', type: 'Portfolio', pinned: false },
    { id: 5, title: 'Crypto Exchange', description: 'Real-time trading interface with candlestick charts.', time: '1d ago', type: 'App', pinned: false },
    { id: 6, title: 'Marketing Analytics', description: 'Data visualization tool for marketing campaigns.', time: '2d ago', type: 'Dashboard', pinned: false },
];
                        ...
                        <div className="w-full max-w-2xl bg-[#09090B] border border-white/10 rounded-2xl shadow-2xl pointer-events-auto flex flex-col max-h-[650px] overflow-hidden ring-1 ring-white/5">
                            ...
                            <div className="flex flex-col gap-4 p-5 border-b border-white/5 bg-[#09090B]">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <span className="text-[10px] font-mono text-neutral-500 bg-white/5 px-2 py-1 rounded">ESC to close</span>
                                    </div>
                                </div>
                                            ...
                                            >
                                                <div className="flex items-center gap-4">
                                                    <div className={cn(
                                                        ...
                                                        item.type === 'SaaS' ? "bg-blue-500/10 text-blue-400" :
                                                        item.type === 'Dashboard' ? "bg-emerald-500/10 text-emerald-400" :
                                                        item.type === 'Portfolio' ? "bg-purple-500/10 text-purple-400" :
                                                    ...
                                                    <div>
                                                        <div className="flex items-center gap-2 mb-0.5">
                                                            <span className="text-sm font-medium text-neutral-200 group-hover:text-white transition-colors">{item.title}</span>
                                                            {item.pinned && <Pin size={10} className="text-neutral-500" fill="currentColor" />}
                                                        </div>
                                                ...
                                                <div className="flex items-center gap-6">
                                                    ...
                                                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-all translate-x-2 group-hover:translate-x-0">
                                                        <button className="p-2 text-neutral-400 hover:text-white hover:bg-white/10 rounded-lg transition-colors" title="Open">
                                                            <ArrowUpRight size={14} />
                                                        </button>
                                                        <button className="p-2 text-neutral-400 hover:text-white hover:bg-white/10 rounded-lg transition-colors" title="Pin">
                                                            <Pin size={14} />
                                                        </button>
                            ...
                            <div className="px-5 py-3 bg-[#09090B] border-t border-white/5 flex items-center justify-between text-[10px] text-neutral-500 font-mono">
                                ...
                                <div className="flex gap-2">
                                    <span className="bg-white/5 px-1.5 py-0.5 rounded text-neutral-400">⌘ K</span>
                                    <span>to toggle</span>
                                </div>
                            </div>
                        </div>
