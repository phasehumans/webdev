    ...
    <div className="flex items-center justify-between p-4 rounded-2xl border border-white/5 bg-[#09090b] hover:border-white/10 transition-all hover:bg-[#0c0c0e] group">
        <div className="flex items-center gap-4">
            <div className={cn(
                ...
                colorClass ? colorClass : (connected ? "bg-white text-black border-white" : "bg-white/5 text-neutral-400 border-white/5 group-hover:text-white")
            )}>
            ...
            <div>
                <h4 className="text-sm font-medium text-white flex items-center gap-2">
                    {name}
                    {connected && username && (
                        <span className="text-[10px] font-normal text-neutral-500 bg-white/5 px-1.5 py-0.5 rounded">@{username}</span>
                    )}
                </h4>
