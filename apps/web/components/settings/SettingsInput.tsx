...
export const SettingsInput: React.FC<SettingsInputProps> = ({ label, defaultValue }) => (
    <div className="group">
        <label className="text-xs text-neutral-500 font-medium mb-2 block group-focus-within:text-white transition-colors pl-1">{label}</label>
        <input 
